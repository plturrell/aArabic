# nGrounding: Lean4 Compiler/Runtime (Mojo/Zig)

nGrounding is a full-stack replacement of Lean4 (v4.26.0) built with
Mojo and Zig. It targets full language feature parity and provides a
