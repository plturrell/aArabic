...
/// Compress FP32 to FP16 (2x compression)
fn compressFP16(data: []const f32, tensor: *CompressedTensor, use_simd: bool) !void {
    _ = use_simd; // TODO: Implement SIMD version
    
    // Simple conversion (no actual FP16 support in Zig yet, use approximation)
    var out_idx: usize = 0;
    for (data) |val| {
