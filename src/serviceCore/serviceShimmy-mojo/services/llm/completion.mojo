...
struct CompletionChoice:
    ...
    fn __init__(inout self, text: String, index: Int, finish_reason: String):
        self.text = text
        self.index = index
...
fn generate_single_completion(prompt: String, config: CompletionConfig) -> String:
    ...
    try:
        ...
        return "Error generating completion: " + str(e)
...
fn handle_completion_request(body: String) -> String:
    ...
    var response = format_completion_response(choices, config, request_id)
