...
struct InferenceClient:
    ...
    fn __init__(inout self, lib_path: String) raises:
    ...
    fn load_model(inout self, model_path: String) raises -> Bool:
        ...
        # Call C API
        var result = external_call["inference_load_model", Int32](
            self.lib,
            c_path
        )
    ...
    fn is_loaded(self) -> Bool:
        ...
        var result = external_call["inference_is_loaded", Int32](self.lib)
        return result == 1
    ...
    fn generate(self, prompt: String, max_tokens: Int = 50, temperature: Float32 = 0.7) raises -> String:
    ...
    fn unload(inout self):
        ...
        if self.model_loaded:
            external_call["inference_unload", NoneType](self.lib)
            self.model_loaded = False
