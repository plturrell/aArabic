...
import { SearchFilter, FilterCriteria } from './SearchFilter';
...
export class NetworkGraph {
    ...
    private multiSelectHandler: MultiSelectHandler;
    ...
    private setupSubComponentCallbacks(): void {
        ...
        this.multiSelectHandler.onSelection((selectedIds: Set<string>) => {
            this.emit('multiSelectionChange', { selectedIds });
        });

        // Search filter callbacks
        this.searchFilter.onFilter((filteredIds: Set<string>) => {
            this.emit('filterChange', { filteredIds });
        });

        this.searchFilter.onHighlight((highlightedIds: Set<string>) => {
    ...
    private updateSubComponentsData(): void {
    ...
    public enableMinimap(): void {
        ...
        this.minimap.onViewportChange((viewport: Viewport) => {
    ...
    public filter(criteria: FilterCriteria): void {
    ...
    public getMultiSelectHandler(): MultiSelectHandler {
