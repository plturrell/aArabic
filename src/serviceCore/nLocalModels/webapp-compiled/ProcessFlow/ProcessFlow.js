 ...
 */
import { ProcessFlowZoomLevel, ProcessFlowDisplayState, DEFAULT_PROCESS_FLOW_CONFIG, PROCESS_FLOW_LAYOUT, ZOOM_LEVEL_CONFIG } from './types';
...
export class ProcessFlow {
    constructor(container, config) {
        ...
        this.isAutoZoom = true; // Auto-detect zoom based on container size
        this.resizeObserver = null;
        // Overflow indicators
        this.leftOverflowIndicator = null;
        this.rightOverflowIndicator = null;
        // Get container
