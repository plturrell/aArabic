...
```
Core:
- src/serviceCore/nOpenaiServer/inference/engine/core/mhc_constraints.zig
- src/serviceCore/nOpenaiServer/inference/engine/core/matrix_ops.zig
- src/serviceCore/nOpenaiServer/inference/engine/core/transformer.zig
- src/serviceCore/nOpenaiServer/inference/engine/core/gguf_loader.zig

Services:
- src/serviceCore/nOpenaiServer/services/translation/handlers.mojo
- src/serviceCore/nOpenaiServer/services/embedding/service.mojo
- src/serviceCore/nOpenaiServer/services/rag/service.mojo

Orchestration:
- src/serviceCore/nOpenaiServer/orchestration/tools/rl/kto_policy.mojo
- src/serviceCore/nOpenaiServer/orchestration/evaluation/tau2_bench/tau2/agent/llm_agent.mojo
```
