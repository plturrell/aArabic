...
## Lean4 Runtime Service

Build and run the Lean4 HTTP service (Zig):

```bash
./scripts/build_zig.sh
./scripts/start_lean4_server.sh
```
...
curl -s http://localhost:8002/v1/lean4/check \
...
```text
SHIMMY_LEAN4_HOST=0.0.0.0
SHIMMY_LEAN4_PORT=8002
SHIMMY_LEAN4_WORK_DIR=tmp/lean4
SHIMMY_LEAN4_MAX_OUTPUT_BYTES=1048576
LEAN4_BIN=lean
LEAN4_ROOT=/path/to/lean/root
```
