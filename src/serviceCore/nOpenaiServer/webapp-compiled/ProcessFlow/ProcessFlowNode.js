 ...
 */
import { ProcessFlowNodeState, ProcessFlowDisplayState, ProcessFlowZoomLevel, PROCESS_FLOW_COLORS, PROCESS_FLOW_LAYOUT, ZOOM_LEVEL_CONFIG } from './types';
export class ProcessFlowNode {
    constructor(config) {
        this.isExpanded = false;
        this.foldTriangle = null; // Folded corner triangle
        this.detailTexts = [];
        this.icon = null;
        this.statusIcon = null; // Icon-only mode for Level 4
        this.stackElements = []; // Stack shadow elements
        this.counterBadge = null; // Counter badge group
        // Display state
        this.displayState = ProcessFlowDisplayState.Regular;
        // Zoom level
        this.currentZoomLevel = ProcessFlowZoomLevel.Two;
        this.currentZoomConfig = ZOOM_LEVEL_CONFIG[ProcessFlowZoomLevel.Two];
        // Position
        this.x = 0;
        this.y = 0;
        this.id = config.id;
