...
export type GroupToggleCallback = (event: GroupToggleEvent) => void;
...
export class GraphGroup {
    ...
    public nodeIds: Set<string>;
    public element: SVGGElement;
    public bounds: { x: number; y: number; width: number; height: number };

    private headerElement: SVGGElement | null = null;
    private contentElement: SVGGElement | null = null;
    private toggleButton: SVGGElement | null = null;
    private isAnimating: boolean = false;
    private onToggleCallback: GroupToggleCallback | null = null;
    private collapsedBounds: { x: number; y: number; width: number; height: number };
    ...
    public onToggle(callback: GroupToggleCallback): void {
    ...
    private renderCollapsedBadge(cx: number, cy: number): void {
