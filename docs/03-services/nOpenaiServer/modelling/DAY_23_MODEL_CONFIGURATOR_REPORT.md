...
**File:** `src/serviceCore/nOpenaiServer/webapp/view/ModelConfigurator.view.xml`
...
**File:** `src/serviceCore/nOpenaiServer/webapp/controller/ModelConfigurator.controller.js`
...
**File:** `src/serviceCore/nOpenaiServer/webapp/i18n/i18n.properties`
...
**File:** `src/serviceCore/nOpenaiServer/webapp/manifest.json`
...
**File:** `src/serviceCore/nOpenaiServer/webapp/view/Main.view.xml`
...
**File:** `src/serviceCore/nOpenaiServer/webapp/controller/Main.controller.js`
