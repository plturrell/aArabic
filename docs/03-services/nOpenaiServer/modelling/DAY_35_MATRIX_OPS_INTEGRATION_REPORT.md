...
**Location:** `src/serviceCore/nOpenaiServer/inference/engine/core/matrix_ops.zig`
...
**File:** `src/serviceCore/nOpenaiServer/inference/engine/core/test_mhc_integration.zig`
