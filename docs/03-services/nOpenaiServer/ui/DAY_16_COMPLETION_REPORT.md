...
1. `src/serviceCore/nOpenaiServer/odata/service.zig` (260 lines)
2. `src/serviceCore/nOpenaiServer/odata/query_builder.zig` (220 lines)
3. `src/serviceCore/nOpenaiServer/odata/handlers/prompts.zig` (210 lines)
