...
### Created:
1. `src/serviceCore/nLocalModels/webapp/utils/TokenManager.js` - JWT token management utility

### Modified:
1. `src/serviceCore/nLocalModels/webapp/controller/PromptTesting.controller.js`:
