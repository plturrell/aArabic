...
**Location:** `src/serviceCore/nLocalModels/sap-toolkit-mojo/lib/clients/hana/deploy_tables.zig`
...
**Location:** `src/serviceCore/nLocalModels/scripts/deploy_hana_tables.sh`
...
**Location:** `src/serviceCore/nLocalModels/scripts/verify_hana_tables.sh`
