...
```bash
# Run all unit tests
zig test src/serviceCore/nLocalModels/inference/engine/core/mhc_constraints.zig
zig test src/serviceCore/nLocalModels/inference/engine/core/matrix_ops.zig
zig test src/serviceCore/nLocalModels/inference/engine/core/transformer.zig
zig test src/serviceCore/nLocalModels/inference/engine/core/gguf_loader.zig
zig test src/serviceCore/nLocalModels/inference/engine/core/mhc_configuration.zig
...
zig test --coverage src/serviceCore/nLocalModels/inference/engine/core/*.zig
